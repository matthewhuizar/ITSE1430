...
namespace Nile
{
    ...
    public class ProductDatabase 
    {
        public ProductDatabase ()
        {
            ...
            _products[0].IsDiscontinued = true;

            _products[1] = new Product();
            _products[1].Name = "Microwave Oven";
            _products[1].Price = 150;
            _products[1].IsDiscontinued = true;

            _products[2] = new Product();
            _products[2].Name = "Samsung Note 7";
            _products[2].Price = 100;
            _products[2].IsDiscontinued = false;
        ...
        public Product[] GetAll ()
        {
            ...
            foreach (var product in _products) // in array to be used
            {
                //product = new Product(); //do not do
        ...
        /// <summary>Remove the product.</summary>
